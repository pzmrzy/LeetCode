...
bfs时要记录路径
### 114/ [flattten Binary Tree to Linked List](https://leetcode.com/problems/flatten-binary-tree-to-linked-list/)
...
### 332. [Reconstruct Itinerary](https://leetcode.com/problems/reconstruct-itinerary/) [|python|](https://github.com/pzmrzy/LeetCode/blob/master/python/reconstruct_itinerary.py)
